...
function CommentsSection({ user }) {
  ...
  const handleSubmit = () => {
    ...
    setComments(prev => [{
      id: Date.now(), user: user.name, initials,
      avatarIdx: 4, school, rating, text: text.trim(),
  ...
  return (
    <section style={{background:"#F8FAFC", borderTop:"1px solid #E8EEF6",
  ...
  <div style={{display:"flex",flexDirection:"column",gap:12}}>
    ...
    <div style={{display:"flex",alignItems:"center",gap:8,
      ...
      <div style={{width:30,height:30,borderRadius:"50%",background:"#185FA5",
        display:"flex",alignItems:"center",justifyContent:"center",
    ...
    <div style={{display:"flex",justifyContent:"flex-end",alignItems:"center",gap:10}}>
      ...
      <button
        ...
        style={{
          ...
          borderRadius:9,
          border:"none",
          background:(!school||!text.trim()||rating===0)
            ? "#94A3B8"
            : "#185FA5",
          color:"#fff",
          fontSize:13,
          fontWeight:600,
          cursor:(!school||!text.trim()||rating===0)
            ? "not-allowed"
            : "pointer",
          fontFamily:"inherit",
